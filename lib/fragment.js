...
var Fragment = (_class = function () {
	...
	(0, _createClass3.default)(Fragment, [{
		...
		value: function getDataIn(store) {
			...
			return function (path, specific, onDataNotFoundAll, onDataNotFound) {
				...
				var ondfa = typeof _this2.onDataNotFoundAll === 'function' ? _this2.onDataNotFoundAll.bind(_this2) : undefined;
				var ondf = typeof _this2.onDataNotFound === 'function' ? _this2.onDataNotFound.bind(_this2) : onDataNotFound;
				...
				if (path) {
					...
					if ((typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) !== 'object') {
						if ((_this2.onDataNotFound || onDataNotFound) && (value === undefined || value === null)) {
							var v = void 0;
							if (_this2.onDataNotFound) {
								v = _this2.onDataNotFound(path);
							}
						...
						if ((value === undefined || value === null) && !_this2.dataNotFoundPaths.find(function (v) {
							...
							var nfValue = void 0;
							if (typeof _this2.onDataNotFoundAll === 'function') {
								nfValue = _this2.onDataNotFoundAll(path);
							}
					...
					if (_immutable.Iterable.isIterable(value)) {
						if (nfPath && !_this2.dataNotFoundPaths.find(function (v) {
							...
							var _nfValue = void 0;
							if (typeof _this2.onDataNotFoundAll === 'function') {
								_nfValue = _this2.onDataNotFoundAll(nfPath);
							}
							if (typeof onDataNotFoundAll === 'function') {
          ...
          */
									...
									if ((_this2.onDataNotFound || onDataNotFound) && (next === undefined || next === null) && (prev === undefined || prev === null)) {
										var _v = void 0;
										if (_this2.onDataNotFound) {
											_v = _this2.onDataNotFound(localPath.concat(key).join('.'));
										}
     ...
     */
					...
					if ((_this2.onDataNotFound || onDataNotFound) && (result === undefined || result === null)) {
						var _v2 = void 0;
						if (_this2.onDataNotFound) {
							_v2 = _this2.onDataNotFound(path);
						}
       ...
       */
							...
							if ((_this2.onDataNotFound || onDataNotFound) && (_result === undefined || _result === null)) {
								var _v3 = void 0;
								if (_this2.onDataNotFound) {
									_v3 = _this2.onDataNotFound(localPath.concat(key).join('.'));
								}
				...
				if ((_this2.onDataNotFound || onDataNotFound) && (value === undefined || value === null)) {
					var _v4 = void 0;
					if (_this2.onDataNotFound) {
						_v4 = _this2.onDataNotFound(path);
					}
		...
		value: function dispatchFragment(path, setStore, getStore) {
			...
			if (!this.initialize) {
				...
				this._getData = function (getPath, getRealData, specific, onDataNotFoundAll, onDataNotFound) {
					...
					if (!getPath) {
						...
						if (_this4.normalizeData) {
							...
							result = _this4.userGetData(_this4.emptyPath, getRealData, specific, onDataNotFoundAll, onDataNotFound);
						}
					...
					if (!newPath) {
						...
						result = _this4.userGetData(newPath, getRealData, specific, onDataNotFoundAll, onDataNotFound);
				...
				this.getData = function (getPath) {
					var result = _this4._getData(getPath, _this4.getDataIn(), undefined, _this4.onDataNotFoundAll, _this4.onDataNotFound);
					_this4.getCounter();
					return result;
				};
				...
				if (this.onDataNotFoundAll) {
					...
					this.onDataNotFoundAll = function () {
						...
						return _this4.useronDataNotFoundAll.apply(_this4, arguments);
					};
				}
