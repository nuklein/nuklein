...
var Fragment = (_class = function () {
	...
	(0, _createClass3.default)(Fragment, [{
		...
		value: function getDataIn(store) {
			...
			return function (path, info, specific, onDataNotFound, onDataNotFoundOne) {
				...
				if (path) {
					var res = (0, _getPathParse2.default)(path, value, info, ondf, ondfo);
					value = res.value;
					...
					if ((typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) !== 'object') {
						if ((_this2.onDataNotFoundOne || onDataNotFoundOne) && (value === undefined || value === null)) {
							...
							if (_this2.onDataNotFoundOne) {
								v = _this2.onDataNotFoundOne(path, info);
							}
						...
						if ((value === undefined || value === null) && !_this2.dataNotFoundPaths.find(function (v) {
							...
							if (typeof _this2.onDataNotFound === 'function') {
								nfValue = _this2.onDataNotFound(path, info);
							}
					...
					if (_immutable.Iterable.isIterable(value)) {
						if (nfPath && !_this2.dataNotFoundPaths.find(function (v) {
							...
							var _nfValue = void 0;
							if (typeof _this2.onDataNotFound === 'function') {
								_nfValue = _this2.onDataNotFound(nfPath, info);
							}
							if (typeof onDataNotFound === 'function') {
								_nfValue = onDataNotFound(nfPath, info);
							}
							if (_nfValue && value) {
          ...
          */
									...
									if ((_this2.onDataNotFoundOne || onDataNotFoundOne) && (next === undefined || next === null) && (prev === undefined || prev === null)) {
										var _v = void 0;
										if (_this2.onDataNotFoundOne) {
											_v = _this2.onDataNotFoundOne(localPath.concat(key).join('.'), info);
										}
										if ((_v === undefined || _v === null) && onDataNotFoundOne) {
											_v = onDataNotFoundOne(localPath.concat(key).join('.'), info);
										}
     ...
     */
					...
					if ((_this2.onDataNotFoundOne || onDataNotFoundOne) && (result === undefined || result === null)) {
						var _v2 = void 0;
						if (_this2.onDataNotFoundOne) {
							_v2 = _this2.onDataNotFoundOne(path, info);
						}
						if ((_v2 === undefined || _v2 === null) && onDataNotFoundOne) {
							_v2 = onDataNotFoundOne(path, info);
						}
       ...
       */
							...
							if (v._getData && typeof v._getData === 'function') {
								_result = v._getData(undefined, v.getDataIn(), info, specific, ondf);
								v.getCounter();
							} else {
								v.beforeGet();
								_result = v.getData(undefined, v.getDataIn(), info, specific, ondf);
								v.getCounter();
							...
							if ((_this2.onDataNotFoundOne || onDataNotFoundOne) && (_result === undefined || _result === null)) {
								var _v3 = void 0;
								if (_this2.onDataNotFoundOne) {
									_v3 = _this2.onDataNotFoundOne(localPath.concat(key).join('.'), info);
								}
								if ((_v3 === undefined || _v3 === null) && onDataNotFoundOne) {
									_v3 = onDataNotFoundOne(localPath.concat(key).join('.'), info);
								}
				...
				if ((_this2.onDataNotFoundOne || onDataNotFoundOne) && (value === undefined || value === null)) {
					var _v4 = void 0;
					if (_this2.onDataNotFoundOne) {
						_v4 = _this2.onDataNotFoundOne(path, info);
					}
					if ((_v4 === undefined || _v4 === null) && onDataNotFoundOne) {
						_v4 = onDataNotFoundOne(path, info);
					}
		...
		key: 'getData',
		value: function getData(path, getRealData, info, specific, onDataNotFound, onDataNotFoundOne) {
			return this.getDataIn()(this.beforeGet(path), info, specific, onDataNotFound, onDataNotFoundOne);
		}
     ...
     */
		...
		value: function dispatchFragment(path, setStore, getStore) {
			...
			if (!this.initialize) {
				...
				this._getData = function (getPath, getRealData, info, specific, onDataNotFound, onDataNotFoundOne) {
					var result = void 0;
					if (!getPath) {
						...
						if (_this4.normalizeData) {
							...
							result = _this4.userGetData(_this4.emptyPath, getRealData, info, specific, onDataNotFound, onDataNotFoundOne);
						}
					...
					if (!newPath) {
						...
						result = _this4.userGetData(newPath, getRealData, info, specific, onDataNotFound, onDataNotFoundOne);
				...
				this.getData = function (getPath, info) {
					var result = _this4._getData(getPath, _this4.getDataIn(), info, undefined, _this4.onDataNotFound, _this4.onDataNotFoundOne);
					_this4.getCounter();
					return result;
				};
