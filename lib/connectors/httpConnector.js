			...
			(0, _createClass3.default)(HttpConnector, [{
				...
				value: function getDataFromServer(path) {
					...
					(0, _isomorphicFetch2.default)(addr, {
						...
						var data = res;
						if (afterGetData) {
							data = (0, _extends3.default)({}, res, afterGetData);
						}
						_this2.dataNotFoundPaths = [];
						_this2.data.dataNotFoundPaths = [];
						_this2.data.setData(data, null, null, { method: _this2.onDataNotFoundAll });
					}).catch(function (err) {
